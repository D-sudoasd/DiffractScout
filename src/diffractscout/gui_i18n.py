...
STRINGS: dict[str, dict[str, str]] = {
    "zh": {
        ...
        "include_figures": "生成 2θ 图件（SVG/PNG）",
        ...
        "source_preset": "辐射源",
        "radiation_value": "辐射值",
        "radiation_value_A": "辐射值 (Å)",
        "radiation_value_keV": "辐射值 (keV)",
        "input_mode": "输入模式",
        "two_theta_min": "2θ 最小 (°)",
        "two_theta_max": "2θ 最大 (°)",
        "step": "步长 (°)",
    ...
    "en": {
        ...
        "include_figures": "Generate 2theta figures (SVG/PNG)",
        ...
        "radiation_value": "Radiation value",
        "radiation_value_A": "Radiation value (Å)",
        "radiation_value_keV": "Radiation value (keV)",
        ...
        "pattern_axis": "CSV/Excel pattern coordinate",
